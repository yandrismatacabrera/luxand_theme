...
class Interceptor extends \Sm\ListingTabs\Block\ListingTabs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function _tagId()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_tagId', func_get_args(), $pluginInfo) : parent::_tagId();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_isAjax');
        return $pluginInfo ? $this->___callPlugins('_isAjax', func_get_args(), $pluginInfo) : parent::_isAjax();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getFormKey');
        return $pluginInfo ? $this->___callPlugins('_getFormKey', func_get_args(), $pluginInfo) : parent::_getFormKey();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getList');
        return $pluginInfo ? $this->___callPlugins('_getList', func_get_args(), $pluginInfo) : parent::_getList();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_ajaxLoad');
        return $pluginInfo ? $this->___callPlugins('_ajaxLoad', func_get_args(), $pluginInfo) : parent::_ajaxLoad();
    }
    ...
    public function getLabel($filter)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getLabel', func_get_args(), $pluginInfo) : parent::getLabel($filter);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getOrderFields');
        return $pluginInfo ? $this->___callPlugins('_getOrderFields', func_get_args(), $pluginInfo) : parent::_getOrderFields($collection, $tab);
    }
    ...
    public function _getProductsBasic($catids = null, $tab = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_getProductsBasic', func_get_args(), $pluginInfo) : parent::_getProductsBasic($catids, $tab);
    }
    ...
    public function getAjaxUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAjaxUrl', func_get_args(), $pluginInfo) : parent::getAjaxUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_setSerialize');
        return $pluginInfo ? $this->___callPlugins('_setSerialize', func_get_args(), $pluginInfo) : parent::_setSerialize($str);
    }
