...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Category\Flat\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addParentPathFilter');
        return $pluginInfo ? $this->___callPlugins('addParentPathFilter', func_get_args(), $pluginInfo) : parent::addParentPathFilter($parent);
    }
    ...
    public function addStoreFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoreFilter', func_get_args(), $pluginInfo) : parent::addStoreFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSortedField');
        return $pluginInfo ? $this->___callPlugins('addSortedField', func_get_args(), $pluginInfo) : parent::addSortedField($sorted);
    }
