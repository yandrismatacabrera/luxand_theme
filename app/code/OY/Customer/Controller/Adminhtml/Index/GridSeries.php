 ...
 */
class GridSeries extends \Magento\Backend\App\Action
{

    const BLOCK_GRID = 'OY\Customer\Block\Adminhtml\Edit\Tab\SeriesGrid';
    const BLOCK_GRID_NAME = 'adminhtml.customer.edit.tab.series';
